...
from head_of.models import HeadDepartment
...
class Department(BaseModel):
    ...
    head_of = models.ForeignKey(HeadDepartment, on_delete=models.CASCADE, related_name='departments', null=True, blank=True)
